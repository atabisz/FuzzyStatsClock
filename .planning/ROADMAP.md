...
<details>
<summary>✅ v3.6 Settings Layout Fix (Phase 56) — SHIPPED 2026-03-18</summary>

- [x] **Phase 56: Settings Window Layout Redesign** — All Appearance tab controls visible within 480×600 without clipping; theme cards compacted; inter-section spacing tightened; Stats and Behavior tabs unaffected (SETT-01–04) (completed 2026-03-18)
...
**Goal**: Widget colors remain stable when AutoContrast or BackdropAlwaysVisible is active over an empty desktop, and AutoContrast continues to switch correctly over application windows
**Depends on**: Phase 56
**Requirements**: FIX-01, FIX-02, FIX-03
**Success Criteria** (what must be TRUE):
  1. With AutoContrast enabled and the widget positioned over an empty desktop (no app window beneath), text color does not oscillate or flicker — it holds steady
