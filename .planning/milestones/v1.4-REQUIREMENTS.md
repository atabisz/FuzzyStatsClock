# Requirements Archive: v1.4 PAG Stat Row
...
- [x] **STAT-12**: User can toggle PAG row visibility via right-click Stats submenu; checkmark reflects actual PAG row state each time menu opens
- [x] **STAT-13**: Hiding all four stat rows (CPU/GPU/MEM/PAG) auto-collapses the stats panel
...
| STAT-12 | Phase 11 | Complete |
| STAT-13 | Phase 11 | Complete |
...
*Last updated: 2026-02-26 after v1.4 milestone shipped — all 5 requirements delivered and human-verified*
