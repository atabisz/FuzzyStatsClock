...
| 7 | Behavior tab exposes battery alert threshold controls (SETT-05) | VERIFIED | REQUIREMENTS.md SETT-05 scopes Behavior tab to ghost mode, auto-contrast, and auto-launch only; battery alert threshold is ALERT-03 (Phase 44). All three scoped controls are present: ChkGhostMode, ChkAutoContrast, ChkAutoLaunch. |
...
| SETT-05 | 42-02 | Behavior tab: ghost mode, auto-contrast, auto-launch (battery alert is ALERT-03/Phase 44) | SATISFIED | Ghost mode, auto-contrast, auto-launch present and wired; battery alert threshold is explicitly out of SETT-05 scope per REQUIREMENTS.md |
...
**Note on SETT-03:** Theme selector is explicitly deferred to Phase 43 per RESEARCH.md and CONTEXT.md. REQUIREMENTS.md tracks this deferral and SETT-03 remains PARTIAL until Phase 43 delivers the theme selector.
